...
lots = CSV.read("web/foreclosures/lots.csv", DataFrame)
bids = CSV.read("web/foreclosures/bids.csv", DataFrame)
sales = CSV.read("web/foreclosures/auction_sales.csv", DataFrame)
pluto = CSV.read("web/foreclosures/pluto.csv", DataFrame)
